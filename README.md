...
Predicts product sales from pricing, discount, marketing spend, and customer segment. Built end-to-end: preprocessing, feature engineering, training, evaluation, and a CRUD REST API to serve predictions.
